...
import { CustomPluginOptions, ExistingRawSourceMap, GetManualChunk, InputOption, InputOptions, LoadResult, MinimalPluginContext, ModuleFormat, ModuleInfo, ObjectHook, OutputBundle, OutputChunk, PartialResolvedId, PluginHooks, ResolveIdResult, RollupError, RollupOptions, RollupOutput, RollupWatcher, SourceDescription, SourceMap, SourceMapInput, WatcherOptions } from 'rollup';
import { FetchFunctionOptions, FetchResult, ModuleEvaluator, ModuleRunner, ModuleRunnerHmr, ModuleRunnerOptions } from 'vite/module-runner';
import { InferCustomEventPayload } from 'vite/types/customEvent';
import { CustomPayload, HotPayload } from 'vite/types/hmrPayload';
import { LessPreprocessorBaseOptions, SassLegacyPreprocessBaseOptions, SassModernPreprocessBaseOptions, StylusPreprocessorBaseOptions } from 'vite/types/internal/cssPreprocessorOptions';
import { LightningCSSOptions } from 'vite/types/internal/lightningcssOptions';
...
export { ConnectedPayload, CustomPayload, ErrorPayload, FullReloadPayload, HMRPayload, HotPayload, PrunePayload, Update, UpdatePayload } from 'vite/types/hmrPayload';
export { GeneralImportGlobOptions, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from 'vite/types/importGlob';
export { LightningCSSOptions } from 'vite/types/internal/lightningcssOptions';
...
export { build, BuildEnvironment, buildErrorMessage, Connect, createBuilder, createFilter, createIdResolver, createLogger, createRunnableDevEnvironment, createServer, createServerHotChannel, createServerModuleRunner, DEFAULT_CLIENT_CONDITIONS as defaultClientConditions, DEFAULT_CLIENT_MAIN_FIELDS as defaultClientMainFields, DEFAULT_SERVER_CONDITIONS as defaultServerConditions, DEFAULT_SERVER_MAIN_FIELDS as defaultServerMainFields, defineConfig, DevEnvironment, EnvironmentModuleGraph, EnvironmentModuleNode, fetchModule, formatPostcssSourceMap, FSWatcher, HttpProxy, isCSSRequest, isFileLoadingAllowed, isFileServingAllowed, isRunnableDevEnvironment, loadConfigFromFile, loadEnv, mergeAlias, mergeConfig, ModuleGraph, ModuleNode, ssrTransform as moduleRunnerTransform, normalizePath, optimizeDeps, perEnvironmentPlugin, perEnvironmentState, PluginContainer, preprocessCSS, preview, resolveConfig, resolveEnvPrefix, rollupVersion, RunnableDevEnvironment, searchForWorkspaceRoot, send, sortUserPlugins, splitVendorChunk, SplitVendorChunkCache, splitVendorChunkPlugin, Terser, transformWithEsbuild, VERSION as version, WebSocket, WebSocketAlias, WebSocketServer, type Alias, type AliasOptions, type AnymatchFn, type AnymatchPattern, type AppType, type BindCLIShortcutsOptions, type BuildEnvironmentOptions, type BuilderOptions, type BuildOptions, type CLIShortcut, type CommonServerOptions, type ConfigEnv, type CorsOptions, type CorsOrigin, type CSSModulesOptions, type CSSOptions, type DepOptimizationConfig, type DepOptimizationMetadata, type DepOptimizationOptions, type DevEnvironmentContext, type DevEnvironmentOptions, type Environment, type EnvironmentOptions, type ESBuildOptions, type ESBuildTransformResult, type ExperimentalOptions, type ExportsData, type FetchModuleOptions, type FileSystemServeOptions, type FilterPattern, type HMRBroadcaster, type HMRBroadcasterClient, type HMRChannel, type HmrContext, type HmrOptions, type HookHandler, type HotChannel, type HotChannelClient, type HotChannelListener, type HotUpdateOptions, type HTMLOptions, type HtmlTagDescriptor, type HttpServer, type IndexHtmlTransform, type IndexHtmlTransformContext, type IndexHtmlTransformHook, type IndexHtmlTransformResult, type InlineConfig, type InternalResolveOptions, type JsonOptions, type LegacyOptions, type LessPreprocessorOptions, type LibraryFormats, type LibraryOptions, type LogErrorOptions, type Logger, type LoggerOptions, type LogLevel, type LogOptions, type LogType, type Manifest, type ManifestChunk, type MapToFunction, type AnymatchMatcher as Matcher, type ModulePreloadOptions, type ModuleRunnerTransformOptions, type OptimizedDepInfo, type Plugin, type PluginHookUtils, type PluginOption, type PreprocessCSSResult, type PreviewOptions, type PreviewServer, type PreviewServerHook, type ProxyOptions, type RenderBuiltAssetUrl, type ResolvedBuildEnvironmentOptions, type ResolvedBuildOptions, type ResolvedConfig, type ResolvedCSSOptions, type ResolvedDevEnvironmentOptions, type ResolvedModulePreloadOptions, type ResolvedPreviewOptions, type ResolvedServerOptions, type ResolvedServerUrls, type ResolvedSSROptions, type ResolvedUrl, type ResolvedWorkerOptions, type ResolveFn, type ResolveModulePreloadDependenciesFn, type ResolveOptions, type ResolverFunction, type ResolverObject, type RollupCommonJSOptions, type RollupDynamicImportVarsOptions, type RunnableDevEnvironmentContext, type SassPreprocessorOptions, type SendOptions, type ServerHMRChannel, type ServerHook, type ServerHotChannel, type ServerModuleRunnerOptions, type ServerOptions, type SkipInformation, type SsrDepOptimizationConfig, type SSROptions, type SSRTarget, type StylusPreprocessorOptions, type TerserOptions, type TransformOptions, type TransformResult, type UserConfig, type UserConfigExport, type UserConfigFn, type UserConfigFnObject, type UserConfigFnPromise, type ViteBuilder, type ViteDevServer, type WatchOptions, type WebSocketClient, type WebSocketCustomListener };
